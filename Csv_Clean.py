...
# A bucket is a flat structure but AWS likes to make a hierarchical structure.
# we created a passcard in the aws directory in terminal
# and used it in the aws database via the boto3 connection

# use files get object parameter to have a look in the bucket
#  the function in boto3 take capitalized keys
#  boto3 returns dictionaries because it is an API
